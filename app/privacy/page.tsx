          ...
          <motion.div
              ...
              <div className='space-y-6'>
                ...
                <div>
                  ...
                  <ul className='list-disc pl-6 space-y-4 text-gray-600'>
                    <li>
                      <p>
                        <strong className='text-[#003366]'>Account</strong>{" "}
                    ...
                    <li>
                      <p>
                        <strong className='text-[#003366]'>Affiliate</strong>{" "}
                    ...
                    <li>
                      <p>
                        ...
                        "Our" in this Agreement) refers to BSH Logistics, Halane
                        AH/MIA, Mogadishu, Somalia.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong className='text-[#003366]'>Cookies</strong> are
                    ...
                    <li>
                      <p>
                        <strong className='text-[#003366]'>Country</strong>{" "}
                        refers to: Somalia
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong className='text-[#003366]'>Device</strong> means
                    ...
                    <li>
                      <p>
                        <strong className='text-[#003366]'>Service</strong>{" "}
                    ...
                    <li>
                      <p>
                        <strong className='text-[#003366]'>Usage Data</strong>{" "}
                    ...
                    <li>
                      <p>
                        <strong className='text-[#003366]'>Website</strong>{" "}
                        refers to BSH Logistics, accessible from{" "}
                        <a
                    ...
                    <li>
                      <p>
                        <strong className='text-[#003366]'>You</strong> means
            ...
            <section>
              ...
              <div className='space-y-6'>
                ...
                <ul className='list-disc pl-6 space-y-4 text-gray-600'>
                  ...
                  <li>
                    <strong className='text-[#003366]'>Web Beacons.</strong>{" "}
            ...
            <section>
              ...
              <ul className='list-disc pl-6 space-y-4 text-gray-600'>
                ...
                <li>
                  <p>
                    <strong className='text-[#003366]'>To contact You:</strong>{" "}
                ...
                <li>
                  <p>
                    <strong className='text-[#003366]'>To provide You</strong>{" "}
              ...
              <ul className='list-disc pl-6 space-y-4 text-gray-600'>
                ...
                <li>
                  <strong className='text-[#003366]'>With Affiliates:</strong>{" "}
                ...
                <li>
                  <strong className='text-[#003366]'>With other users:</strong>{" "}
                ...
                <li>
                  <strong className='text-[#003366]'>With Your consent</strong>:
            ...
            <section>
              ...
              <ul className='list-disc pl-6 space-y-4 text-gray-600'>
                <li>By email: info@bshlogistics.com</li>
              </ul>
            </section>
          </motion.div>
        </div>
